...
<body onload="set_style_from_cookie()" onresize="ajustar_div_variable()">
    ...
    <div id="container-accesibilidad-zoom"> 
        ...
        <div class="barra-de-accesibilidad-informacion">
            ...
            <div class="encabezado_ayuda"><img alt="Logo del Ministerio de Relaciones Exteriores y Culto. República Argentina" src="/images/ministerio-relaciones-exteriores-y-culto-logo.png"></div>
        ...
        <footer class="clearfix">
            <div class="footer-container">
                <div class="footer-left">
                    <p>Ministerio de Relaciones Exteriores y Culto de la República Argentina.<br/>

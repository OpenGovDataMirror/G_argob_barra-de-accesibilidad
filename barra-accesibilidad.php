...
<!-- - - - - - - - - - - - -->
  ...
  <noscript>
    <div class="estilo-noscript"><span class="signo-de-alerta">‼ </span>La funcionalidad de la Barra de Accesibilidad está reducida porque depende de una librería que no está disponible. (JQuery/JavaScript).</div>
    <style>
  ...
  <div id="accesibilidad-background">
    <div id="barra-accesibilidad">
      <div id="caja-titulo">
        <span class="opciones-accesibilidad-titulo">Herramientas de Accesibilidad</span>
        <br>
        Cancillería Argentina
        <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/ayuda.php" target="_blank" title="Información y ayuda sobre las Herramientas de Accesibilidad" class="informacion-adicional"><img src="http://<?php echo $_SERVER['SERVER_NAME'];?>/images/icono-mas-informacion.svg" alt="Ayuda y más información." width="16" height="16"></a>
      </div>
      <ul id="ul-barra-accesibilidad">
        ...
        <li class="barra-accesibilidad-esconder-items-en-movil"><?php // slider de tamaño de fuente ?>Tamaño
          <a href="#" id="minima-magnificacion"><span class="esconder">Haga click en la siguiente imagen para minimizar la magnificación.</span><img src="http://<?php echo $_SERVER['SERVER_NAME'];?>/images/icono-zoom-minimo.svg" alt="Icono de magnificación mínima." width="13" height="36"></a>
          ...
          <a href="#" id="maxima-magnificacion"><span class="esconder">Haga click en la siguiente imagen para maximizar la magnificación.</span><img src="http://<?php echo $_SERVER['SERVER_NAME'];?>/images/icono-zoom-maximo.svg" alt="Icono de magnificación máxima." width="27" height="36"></a>
        </li>

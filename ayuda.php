...
<html>
	...
	<body class="barra-de-accesibilidad-informacion">
		<div class="cerrar-esta-ventana"><a href="#" onclick="cerrar_ventana_ayuda()"><img src="/images/square-remove-button.png" class="img-cerrar-ventana" alt="Cerrar esta ventana."></a></div>

		<div class="encabezado_ayuda"><img src="/images/ministerio-relaciones-exteriores-y-culto-logo.png"></div>
